...
- Usage: Reference from command with `@/Users/rcastrodigital/projetos/zx-control-semana1/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/rcastrodigital/projetos/zx-control-semana1/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/rcastrodigital/projetos/zx-control-semana1/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
