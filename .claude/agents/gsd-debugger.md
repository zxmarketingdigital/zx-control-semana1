...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/rcastrodigital/projetos/zx-control-semana1/.claude
                  → checks /Users/rcastrodigital/projetos/zx-control-semana1/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/rcastrodigital/projetos/zx-control-semana1/.claude/get-shit-done
                  → writes to /Users/rcastrodigital/projetos/zx-control-semana1/.claude/get-shit-done/hooks/
...
@/Users/rcastrodigital/projetos/zx-control-semana1/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/rcastrodigital/projetos/zx-control-semana1/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/rcastrodigital/projetos/zx-control-semana1/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/rcastrodigital/projetos/zx-control-semana1/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/rcastrodigital/projetos/zx-control-semana1/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
